...
from bot.config import ROLE_IDENTIFIE_ID, ROLE_LSPD_ID, ROLE_SAMS_ID, VERIFROLE_CHANNEL_ID
from views.verif_view import VerificationRoleView
import datetime
...
class IdentificationModal(Modal, title="Identification"):
    ...
    grade_specifique = TextInput(label="Grade spécifique (optionnel)",
